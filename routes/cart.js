...
router.post('/addtocart', async (req, res) => {
  try {
    ...
    if (cart) {
      ...
      const product = cart.productsInCart.find(item => item.productId.toString() === productId.toString());
      ...
      cart = new Cart({ userId, productsInCart: [{ productId, productQty: quantity }] });
    }
